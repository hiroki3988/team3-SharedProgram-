...
1. setup your app as  
    ...
    heroku buildpacks:add https://github.com/chanzuckerberg/heroku-buildpack-tesseract
    ```
...
## Note
The fork before this fork solves the [issue](https://github.com/fouady/RoR-Tesseract-Heroku/issues/1) of the missing libraries `libtiff4` and `libjpeg62`.

This fork includes the english training data so it doesn't require a remote download which can end up being a dead link.
...
Modified work Copyright (c) 2016 Yun-Fang Juan
